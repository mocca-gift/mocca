...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { content: @info.content, img: @info.img, img_content_type: @info.img_content_type, title: @info.title }
    end
  ...
  test "should update info" do
    patch :update, id: @info, info: { content: @info.content, img: @info.img, img_content_type: @info.img_content_type, title: @info.title }
    assert_redirected_to info_path(assigns(:info))
  end
