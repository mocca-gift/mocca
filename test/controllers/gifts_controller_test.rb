...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { img: @gift.img, img_content_type: @gift.img_content_type, name: @gift.name, url: @gift.url }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { img: @gift.img, img_content_type: @gift.img_content_type, name: @gift.name, url: @gift.url }
    assert_redirected_to gift_path(assigns(:gift))
  end
